import 'package:indonesia_news_app/models/categorie_model.dart';
...
List<CategorieModel> getCategories(){
  ...
  categorieModel.categorTitle = "Bisnis";
  ...
  categorieModel.categorieName = "Entertainment";
   categorieModel.categorTitle = "Hiburan";
  ...
  categorieModel.categorieName = "General";
   categorieModel.categorTitle = "Umum";
  ...
  categorieModel.categorieName = "Health";
   categorieModel.categorTitle = "Kesehatan";
  ...
  categorieModel.categorieName = "Science";
   categorieModel.categorTitle = "Sains";
  ...
  categorieModel.categorieName = "Sports";
   categorieModel.categorTitle = "Olahraga";
  ...
  categorieModel.categorieName = "Technology";
   categorieModel.categorTitle = "Teknologi";
